jQuery(document).ready(function(){
...

    {
        ...
        if( scripts[i].src && scripts[i].src.match(/top_slide\.js/i))

            jsFolder = scripts[i].src.substr(0, scripts[i].src.lastIndexOf("/") + 1);

    }

    jQuery(".top-slide").amazingslider({
        ...
        transition:"slice,elastic,crossfade,fade,blinds,threed",
